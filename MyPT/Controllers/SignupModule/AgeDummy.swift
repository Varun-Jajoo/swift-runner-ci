...
//    private var xRadius: CGFloat = 120  // Horizontal radius
//    private var yRadius: CGFloat = 100   // Vertical radius
...
//
//        // Define elliptical radii
//        xRadius = (bounds.width / 2) - padding
//        yRadius = (bounds.height / 2) - padding
//
//        updateValuePositions()
//    }
//
...
//                x: bounds.midX + (xRadius * cos(angle)) - (label.bounds.width / 2),
//                y: bounds.midY + (yRadius * sin(angle)) - (label.bounds.height / 2)
//            )
//
