...
class TrainerTypeTableViewCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        self.descLbl.font = AppFont.regular.size(12.0, familyName: familyFunnelSans)
...
//            self.imgSelection.image = UIImage(named: "Unradio")
        } else {
            if let imgView = selectedImg {
                self.bgImgView.image = imgView
            }
//            self.imgSelection.image = UIImage(named: "Radio")
        }
    }
