//
//  CustomRangeSliderDelegate.swift
//  MyPT
//
...
public protocol RangeSeekSliderDelegate: AnyObject {
    ...
    func rangeSeekSlider(_ slider: CustomRangeSlider, didChange minValue: CGFloat, maxValue: CGFloat)

    /// Called when the user has started interacting with the RangeSeekSlider
    ///
    /// - Parameter slider: RangeSeekSlider
    func didStartTouches(in slider: CustomRangeSlider)
    ...
    func rangeSeekSlider(_ slider: CustomRangeSlider, stringForMinValue minValue: CGFloat) -> String?
    ...
    ///   - maxValue: maximum value
    /// - Returns: String to be replaced
    func rangeSeekSlider(_ slider: CustomRangeSlider, stringForMaxValue: CGFloat) -> String?
}
...
public extension RangeSeekSliderDelegate {
    ...
    func didStartTouches(in slider: CustomRangeSlider) {}
    func didEndTouches(in slider: CustomRangeSlider) {}
    func rangeSeekSlider(_ slider: CustomRangeSlider, stringForMinValue minValue: CGFloat) -> String? { return nil }
    func rangeSeekSlider(_ slider: CustomRangeSlider, stringForMaxValue maxValue: CGFloat) -> String? { return nil }
}
