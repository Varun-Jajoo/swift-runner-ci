...
@IBDesignable open class CenterRangeSlider: UIControl {
    ...
    public convenience init(frame: CGRect = .zero, completion: ((CenterRangeSlider) -> Void)? = nil) {
    ...
    open weak var delegate: CenterRangeSliderDelegate?
    ...
    @IBInspectable open var hideCenterHandle: Bool = false {
        didSet {
            centerHandle.isHidden = hideCenterHandle
        }
    }
...
private final class RangeSeekSliderLeftElement: UIAccessibilityElement {
    ...
    override func accessibilityIncrement() {
        guard let slider = accessibilityContainer as? CenterRangeSlider else { return }
