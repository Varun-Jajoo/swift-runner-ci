...
@IBDesignable open class CustomRangeSlider: UIControl {
    ...
    public convenience init(frame: CGRect = .zero, completion: ((CustomRangeSlider) -> Void)? = nil) {
...
private final class RangeSeekSliderLeftElement: UIAccessibilityElement {
    ...
    override func accessibilityIncrement() {
        guard let slider = accessibilityContainer as? CustomRangeSlider else { return }
